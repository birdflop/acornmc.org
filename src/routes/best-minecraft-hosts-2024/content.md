...
Our in-depth analysis is below. At a glance, we conclude:
    ...
    Birdflop (~$1.90/GB): Best Value, Best Performance (Tie)

    Bloom Host (~$2.63/GB): Best Custom Features, Best Performance (Tie)

    PebbleHost ($1/GB): Best Budget Hosting (Tie), Best Support
...
Birdflop also creates and maintains many public resources, including the popular RGB gradient website RGBirdflop and a Discord bot that calculates optimizations for your Minecraft server.
...
Birdflop plans cost ~$1.90/GB RAM for the fastest servers on our list.
...
The specifications for EU hosting (~$1.88/GB) are:
...
# Bloom Host: Best Custom Features, Best Performance (Tie)
...
# PebbleHost: Best Budget Host (Tie), Best Support
...
https://help.pebblehost.com/en/minecraft/how-to-install-forge-to-your-server
