...
export default [
  {
    ...
    description: 'We make sure that our staff have played on the server for a long time so that they are knowledgeable. Only the very best are selected.',
  },
  {
    icon: RefreshCw,
    title: 'Quick Updates',
    description: 'Acorn is always one of the first servers to update to the newest version of Minecraft. We updated to 1.15 on the day of its release.',
  },
  {
    icon: Users2,
